<template>
  <div class="app-container">
    ...
    <el-form :inline="true" class="demo-form-inline">
      ...
      <el-button type="primary" icon="el-icon-search" @click="getPageScholar()">查询</el-button>
      <el-button type="default" icon="el-icon-refresh-left" @click="resetData()">清空</el-button>
    </el-form>

    <!-- 表格列表 -->
    <el-table :data="scholarPage.records" stripe style="width: 100%">
      <el-table-column prop="title" label="title" min-width="180">
      </el-table-column>
      <el-table-column label="year" min-width="100" prop="year">
      </el-table-column>
      <el-table-column prop="totalCitations" label="citations" min-width="80">
      </el-table-column>
    ...
    <el-pagination :current-page="page" :page-size="limit" @size-change="handleSizeChange"
      @current-change="getPageScholar" :page-sizes="[5, 10, 20]" layout="total, sizes, prev, pager, next, jumper"
      :total="total">
    </el-pagination>
  </div>
</template>
