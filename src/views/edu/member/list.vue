<template>
  <div class="app-container">
    ...
    <el-form :inline="true" class="demo-form-inline">
      <el-form-item >
        <el-input v-model="memberQuery.name" placeholder="讲师名"></el-input>
      </el-form-item>
      <el-form-item >
        <el-select v-model="memberQuery.level" clearable placeholder="职位">
      ...
      <template slot-scope="scope">
        <router-link :to="'/member/save/' + scope.row.id">
          ...
          <el-button type="danger" size="mini"
            icon="el-icon-delete"
            @click="removememberById(scope.row.id)">删除</el-button>
      </template>
    </el-table-column>
  </el-table>
